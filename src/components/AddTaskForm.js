  ...
  if (isFormVisible) {
    return (
      <form className='formAddNewTask'>
        ...
        <textarea className='textarea' id='taskDescription' name='description' placeholder='Enter task description' value={values.description} onChange={handleChange} />
        <button onClick={handleSubmit} className='button buttonSubmit' type='submit'>
          Submit
        </button>
      </form>
    );
