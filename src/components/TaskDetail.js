    ...
    return (
      <>
        ...
        <div className='edit'>
          {clicked ? (
            <>
              <textarea className='editText' ref={description} onChange={editNewText} value={task.description} id={task.id}>
                {task.description}
              </textarea>
              <button type='submit' onClick={submitEditText} className='button buttonSubmit'>
                Submit
              </button>
            </>
          ) : (
            <>
              ...
              <button onClick={submitEditText} className='button buttonSubmit'>
                Edit text
              </button>
            </>
          )}
  ...
  const renderEmptyState = () => {
    return (
      <div className='emptyState'>
        <p>
          Task with ID <span className='taskNotFound'>{taskId}</span> was not found.
        </p>
      </div>
    );
  };
