...
export default function List(props) {
  ...
  return (
    <div className='tasklist'>
      ...
      {type === LIST_TYPES.BACKLOG && <AddTaskForm formSubmit={formSubmit} isFormVisible={isFormVisible} setFormVisible={setFormVisible} handleAddNewClick={handleAddNewClick} />}
      ...
      {type === LIST_TYPES.FINISHED && (
        <ReplaceTaskForm
          ...
          handleAddNewClick={handleAddNewClick}
          tasks={allTasks}
          replaceTasks={inProgressTasks}
          setTasks={setTasks}
          newStatus={LIST_TYPES.FINISHED}
        />
      )}
    </div>
  );
